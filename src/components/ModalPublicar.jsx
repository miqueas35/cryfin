    ...
    <div>
      <div>
        ...
        <div className="text-center">
          <button type="button" className="btn btn-success" onClick={openModal}>Publica tú Nuevo Proyecto!!!</button>
        </div>
        ...
        <Modal isOpen={isOpenModal} closeModal={closeModal}>
          ...
          <div className="d-grid gap-2 d-md-flex justify-content-md-end">
            {<Link className="btn btn-success me-md-2" to="/projects">Publicar</Link>}
