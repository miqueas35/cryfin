            ...
            <div className="col-12 mt-3">
                <div className="card d-flex justify-content-center p-3">
                  <div className="d-flex justify-content-center p-3">
                    <img src={logo} className="img-fluid img-logo w-50 h-50" alt="logo" />
                  </div>

    <div className="card-body">
    <h5 className="card-title display-5 text-center my-3">Iniciar sesión</h5>
    <form> 
    <div className="row">
              ...
              <div className="row">
                <div className="d-grid gap-2 col-6 mx-auto my-5">
                  <Link className="btn" to="projects">Iniciar Sesión</Link>
